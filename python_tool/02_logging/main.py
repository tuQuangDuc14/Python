...
if __name__ == '__main__':
    ...
    logging.warning("options = %s  debug = %s",Argument.options[0],Argument.debug[0])
    logging.debug("options = %s  debug = %s",Argument.options[0],Argument.debug[0])
    logging.error("options = %s  debug = %s",Argument.options[0],Argument.debug[0])
